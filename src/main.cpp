...
int main() {
  ...
  MetadataWriter(step_function_solver)
      .write("../data/step_function/metadata.json");
  ...
  MetadataWriter(random_function_solver, f)
      .write("../data/random_function/metadata.json");
