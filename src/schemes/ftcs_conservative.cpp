...
double FTCSConservative::calculateArtificialViscosity(const std::vector<double>& u, double cq, double spatial_step_size, double /*time_step_size*/, int i, int num_domain_points, double /*kinematic_viscosity*/) const {
