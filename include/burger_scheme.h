...
class BurgerScheme {
 public:
  ...
  virtual void calculateNextU(const std::vector<double>& u,
 ...
 protected:
  virtual double calculateArtificialViscosity(const std::vector<double>&,  // u
                                              double,                      // cq
                                              double,     // spatial_step_size
                                              int,        // i
...
class FTCS : public BurgerScheme {
 public:
  void calculateNextU(const std::vector<double>& u, std::vector<double>& u_next,
                      double cq, int num_domain_points, double time_step_size,
                      double spatial_step_size,
 ...
 protected:
  double calculateArtificialViscosity(const std::vector<double>& u, double cq,
                                      double spatial_step_size, int i,
                                      int num_domain_points) const override;
};
...
class Godunov : public BurgerScheme {
 public:
  void calculateNextU(const std::vector<double>& u, std::vector<double>& u_next,
                      double /*cq (unused)*/, int n, double dt, double dx,
                      double kinematic_viscosity) override;
